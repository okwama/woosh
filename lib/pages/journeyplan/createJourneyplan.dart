                            ...
                            child: DropdownButtonFormField<int>(
                              ...
                              decoration: InputDecoration(
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(6),
                                  borderSide: BorderSide(color: const Color.fromARGB(255, 74, 74, 74)),
                                ),
                              ...
                              items: [
                                const DropdownMenuItem<int>(
                                  value: null,
                                  child: Text('No route', style: TextStyle(fontSize: 13)),
                                ),
            ...
            Expanded(
              child: Container(
                ...
                child: widget.clients.isEmpty
                    ? const Center(child: Text('No clients available', style: TextStyle(fontSize: 13)))
                    : filteredClients.isEmpty
                        ? const Center(child: Text('No matching clients found', style: TextStyle(fontSize: 13)))
                        : ListView.builder(
                              ...
                              return InkWell(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    border: Border(
                                      bottom: BorderSide(
                                        color: index == filteredClients.length - 1 
                                            ? Colors.transparent 
